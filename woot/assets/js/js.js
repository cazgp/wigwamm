 ...
 * **************************************************/
  $('.question input').change(function(e) {
    ...
    // If dealing with textbox, we get the value by value
    else {
  ...
  $("input[name='move-in-date']").change(function(e) {
    ...
    $('.move_in_date.summary span').val(e.currentTarget.id);
  });

  // FOCUS THE CURSOR IN THE ADDRESS LINE 1 INPUT ON PAGE LOAD
  $('#id_address_1').focus();
